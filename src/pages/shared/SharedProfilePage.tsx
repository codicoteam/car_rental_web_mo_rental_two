...
const ROLE_META: Record<string, { label: string; color: string }> = {
  ...
  manager:             { label: 'Branch Manager',   color: 'bg-blue-100 text-blue-700 border-blue-200' },
...
interface SharedProfilePageProps {
  SidebarComponent: React.ComponentType<SidebarComponentType>;
}

export default function SharedProfilePage({ SidebarComponent }: SharedProfilePageProps) {
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="px-4 sm:px-6 py-6 space-y-5 max-w-screen-xl mx-auto w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <Card>
                  ...
                  <div className="p-6">
                    {editMode ? (
                      ...
                      <div>
                        <InfoRow label="Full Name" value={<span className="font-medium">{profile?.full_name || '—'}</span>} />
              ...
              {/* RIGHT — Security + Contact + Sign Out */}
              <div className="space-y-5">
