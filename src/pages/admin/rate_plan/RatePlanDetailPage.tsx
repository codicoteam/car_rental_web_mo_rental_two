...
import {
  ...
  Percent, MoreVertical, Hash, Fuel, Settings, Users, ChevronRight,
...
const RatePlanDetailPage: React.FC = () => {
      ...
      <div className="flex h-screen bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center flex-col gap-4">
          ...
          <div className="flex gap-3">
            <button onClick={() => navigate("/admin-rate-plans")} className="flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm">
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-3 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => navigate("/admin-rate-plans")} className="flex items-center gap-1.5 text-gray-500 hover:text-gray-800 text-sm transition-colors">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => navigate("/admin-rate-plans", { state: { editPlanId: plan._id } })}
                      ...
                      <div key={i} className="flex items-start gap-4 bg-gray-50 rounded-xl px-4 py-3 border border-gray-100">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-400 mt-0.5">
                            {fmtDate(o.season?.start)} → {fmtDate(o.season?.end)}
                          </p>
                        </div>
                        {o.daily_rate && (
                          <div className="text-right">
