...
const initialForm: CreateRatePlanPayload = {
  ...
  seasonal_overrides: [], taxes: [], fees: [], active: true, valid_from: "", valid_to: null, notes: "",
};
...
const RatePlans: React.FC = () => {
  ...
  const buildPayload = (): CreateRatePlanPayload => ({
    ...formData,
    vehicle_model_id: planType === "vehicle_model" ? formData.vehicle_model_id : null,
    vehicle_id: planType === "vehicle_unit" ? formData.vehicle_id : null,
    vehicle_class: planType === "vehicle_class" ? formData.vehicle_class : "",
  });
                    ...
                    <div key={plan._id} className="bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col overflow-hidden">
                      ...
                      <div className="px-5 pb-4 flex-1 flex flex-col">
                        ...
                        <div className="mt-auto pt-3 border-t border-gray-100 flex items-center gap-2">
                          <button onClick={() => navigate(`/receptionist/rate-plan/${plan._id}`)}
          ...
          <div className="absolute inset-y-0 right-0 flex max-w-full">
            <div className="relative w-screen max-w-2xl bg-white shadow-2xl flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto px-8 py-6 space-y-7">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Plan Type <span className="text-red-500">*</span></label>
                        ...
                        {(["vehicle_model", "vehicle_unit"] as RatePlanType[]).map(t => {
                          ...
                          return (
                            <button key={t} type="button" onClick={() => setPlanType(t)}
                              ...
                              style={planType === t ? { background: `linear-gradient(to bottom right, ${t === "vehicle_model" ? "#10b981,#0f766e" : "#8b5cf6,#7c3aed"})` } : {}}>
              ...
              <div className="border-t border-gray-200 bg-gray-50 px-8 py-4 flex justify-between items-center">
                ...
                <button
                  onClick={handleSave}
                  disabled={!formData.name || !formData.branch_id || !formData.daily_rate || saving}
