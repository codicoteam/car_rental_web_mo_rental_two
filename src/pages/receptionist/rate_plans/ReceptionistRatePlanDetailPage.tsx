...
const ManagerRatePlanDetailPage: React.FC = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      navigate("/receptionist-rate-plans");
    } catch (err) {
      ...
      <div className="flex h-screen bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center flex-col gap-4">
          ...
          <div className="flex gap-3">
            <button onClick={() => navigate("/receptionist-rate-plans")} className="flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm">
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-3 shadow-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => navigate("/receptionist-rate-plans")} className="flex items-center gap-1.5 text-gray-500 hover:text-gray-800 text-sm transition-colors">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => navigate("/receptionist-rate-plans", { state: { editPlanId: plan._id } })}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {vehicles.map(v => {
                    ...
                    return (
                      <button
                        key={v._id}
                        onClick={() => navigate(`/receptionist/vehicle/${v._id}`)}
