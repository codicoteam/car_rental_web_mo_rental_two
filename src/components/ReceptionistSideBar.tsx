...
const ReceptionistSideBar = ({ isOpen = true, onClose = () => {} }: SidebarProps) => {
  ...
  const sidebarItems = [
    ...
    // Core management
    { icon: Users, label: "Users", path: "/receptionist-users" },

    // Fleet
    { icon: Car, label: "Vehicle Models", path: "/receptionist-vehicle-models" },
    { icon: Car, label: "Vehicles", path: "/receptionist-vehicles" },

    // Operations
    { icon: Calendar, label: "Reservations", path: "/receptionist-reservations" },
    { icon: Wrench, label: "Service Orders", path: "/receptionist-service-orders" },
    { icon: Wrench, label: "Service Schedules", path: "/receptionist-service-schedules" },
    { icon: AlertTriangle, label: "Incidents & Damage", path: "/receptionist-vehicle-incidents" },

    // Business setup
    { icon: ShieldCheck, label: "Rate Plans", path: "/receptionist-rate-plans" },
    { icon: Tag, label: "Promo Codes", path: "/receptionist-promo-codes" },
    { icon: Bell, label: "Notifications", path: "/receptionist-notifications" },
    { icon: MessageSquare, label: "Chats", path: "/receptionist-chats" },

    // Drivers feature
    { icon: UserCheck, label: "Driver Profiles", path: "/receptionist-driver-profiles" },
    { icon: Calendar, label: "Driver Bookings", path: "/receptionist-driver-bookings" },
    { icon: Receipt, label: "Expenses", path: "/receptionist-expenses" },
    { icon: BookOpen, label: "Accounting", path: "/receptionist-accounting" },

    // Account
    { icon: UserCircle, label: "My Profile", path: "/receptionist-profile" },
    ...
    <>
      ...
      >
        ...
        <div className="px-4 py-4 border-t border-gray-100 flex-shrink-0">
          <button
            onClick={() => { navigate('/receptionist-profile'); if (window.innerWidth < 1024) onClose(); }}
