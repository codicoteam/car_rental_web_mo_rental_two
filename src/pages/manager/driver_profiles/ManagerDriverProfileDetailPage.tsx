        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-lg p-10 text-center max-w-md">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button onClick={() => navigate("/manager-driver-profiles")} className="px-5 py-2 border border-gray-300 text-gray-700 rounded-lg font-medium">
                Back to List
              </button>
            </div>
          </div>
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-200 shadow-sm px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => navigate("/manager-driver-profiles")}
